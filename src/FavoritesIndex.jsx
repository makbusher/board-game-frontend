...
import {Card, CardMedia, CardContent, Typography, CardActions, CardActionArea, ImageList} from '@mui/material';
...
export function FavoritesIndex (props) {
  ...
  return (
    <div id="favorites-index">
      ...
      <center>
        <ImageList sx={{ width: 1000, height: 800 }} cols={3} rowHeight={220}>
